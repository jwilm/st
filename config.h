...
static const char *colorname[] = {
	...
	"#b777e0",  /* 13: brmagenta*/
	"#54ced6",  /* 14: brcyan   */
	"#2a2a2a",  /* 15: brwhite (current line) */
	...
	"#2a2a2a", /* 259 - current line */
	"#424242", /* 260 - selection */
	"#eaeaea", /* 261 - foreground */
	"#969896", /* 262 - comment */
	"#aeafad", /* 263 - cursor */
};
...
static unsigned int defaultcs = 263;
